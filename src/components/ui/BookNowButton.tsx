...
export function GetStartedButton() {
  return (
    <Button
      className="cursor-pointer group relative overflow-hidden h-11 px-7 rounded-sm bg-[#2e2721] hover:bg-[#2A1D15] text-white border-none transition-all shadow-md"
      size="lg"
    >
